        ...
        <div class="pt-6">
            ...
            <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
                ...
                <div class="aspect-w-3 aspect-h-4 hidden overflow-hidden rounded-lg lg:block">
                    ...
                    <img :src="`${baseURL}${product.attributes.images.data[0].attributes.url}`" alt="Two each of gray, white, and black shirts laying flat." class="h-full w-full object-cover object-center">
            ...
            <div class="mx-auto max-w-2xl px-4 pt-10 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24">
                ...
                <div class="mt-4 lg:row-span-3 lg:mt-0">
                    ...
                    <p class="text-3xl tracking-tight text-gray-900">{{ product.attributes.price }}</p>
                ...
                <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pt-6 lg:pb-16 lg:pr-8">
                    ...
                    <div>
                        ...
                        <div class="space-y-6">
                            ...
                            <p class="text-base text-gray-900">The Basic Tee 6-Pack allows you to fully express your vibrant personality with three grayscale options. Feeling adventurous? Put on a heather gray tee. Want to be a trendsetter? Try our exclusive colorway: &quot;Black&quot;. Need
...
<script setup>
    ...
    const { data: response } = await useFetch('https://panel.dapurlestari.id/api/products/find-by-slug/' + id + '/?populate=*')
