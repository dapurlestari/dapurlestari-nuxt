<template>
    <NuxtLayout name="scaffold">
        ...
        <div class="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <section class="mt-5">
                <div class="flex">
                    <div class="flex-1 w-14 h-14 relative">
                        ...
                        <i class="lni lni-search-alt absolute right-0 top-0 text-2xl py-3 px-6"></i>
                    </div>
                </div>
            </section>
            ...
            <div class="w-full grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8 mt-5">
                <div v-for="product in products" :key="product.id">
                    <div>
                        <NuxtLink :to="'/products/'+product.attributes.slug" class="group">
                    ...
                    <button class="rounded-lg bg-secondary-500 hover:bg-secondary-600 text-white p-2 w-full text-sm mt-2">
                        Tambah ke keranjang
                    </button>
                </div>
            </div>
