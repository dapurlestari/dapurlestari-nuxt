        ...
        <div class="pt-20">
                ...
                <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                    <li>    
                        <div class="flex items-center">
                            <NuxtLink to="/products" class="mr-2 text-sm font-medium text-gray-900">Products</NuxtLink>
                    ...
                    <li class="text-sm">
                        <a href="#" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600">{{ product.attributes.name }}</a>
                    </li>
                </ol>
            </nav>
            ...
            <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
                <div class="aspect-w-3 aspect-h-4 hidden overflow-hidden rounded-lg lg:block">
                    <img :src="secondaryImage" :alt="product.attributes.name" class="h-full w-full object-cover object-center">
                </div>

                <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
                    <div v-for="image in centerImages" class="aspect-w-3 aspect-h-2 overflow-hidden rounded-lg">
                        <img :src="image" :alt="product.attributes.name" class="h-full w-full object-cover object-center">
                    </div>
                </div>

                <div class="aspect-w-4 aspect-h-5 sm:overflow-hidden sm:rounded-lg lg:aspect-w-3 lg:aspect-h-4">
                    <img :src="primaryImage" :alt="product.attributes.name" class="h-full w-full object-cover object-center">
                </div>
            </div>
            ...
            <div class="mx-auto max-w-2xl px-4 pt-10 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24">
                ...
                <div class="mt-4 lg:row-span-3 lg:mt-0">
                    ...
                    <p class="text-3xl tracking-tight text-gray-900">{{ $formatPrice(product.attributes.price) }}</p>
                    ...
                    <form class="mt-10">
                        ...
                        <div class="mt-10">
                            ...
                            <fieldset class="mt-4">
                                ...
                                <div class="grid grid-cols-4 gap-4 sm:grid-cols-8 lg:grid-cols-4">                                    <!-- Active: "ring-2 ring-indigo-500" -->
                ...
                <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pt-6 lg:pb-16 lg:pr-8">
                    ...
                    <div>
                        ...
                        <div class="space-y-6">
                            <p class="text-base text-gray-900">{{ product.attributes.description }}</p>
                        </div>
                    </div>
...
<script setup>
    ...
    const defaultImagePortrait = $placeholderImageURL(product.attributes.name, 400, 800)

    const mainImage = images.length > 0 
        ? baseURL+images[0].attributes.url 
        : defaultImagePortrait

    const secondaryImage = images.length > 3 
        ? baseURL+images[3].attributes.url 
        : defaultImagePortrait
